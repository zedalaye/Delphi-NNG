unit nng.api.transport;

//
// Copyright 2019 Staysail Systems, Inc. <info@staysail.tech>
// Copyright 2017-2018 Capitar IT Group BV <info@capitar.com>
//
...
function nng_inproc_register: Integer; cdecl; external NNG_LIB;

// ipc transport.  This is used for inter-process communication on
// the same host computer.

function nng_ipc_register: Integer; cdecl; external NNG_LIB;

// TCP transport.  This is used for communication over TCP/IP.

function nng_tcp_register: Integer; cdecl; external NNG_LIB;

// TLS transport.  This is used for communication via TLS v1.2 over TCP/IP.

function nng_tls_register: Integer; cdecl; external NNG_LIB;

// WebSocket transport.  This is used for communication via WebSocket.

function nng_ws_register: Integer; cdecl; external NNG_LIB;

const
  // These aliases are for WSS naming consistency.
  NNG_OPT_WSS_REQUEST_HEADERS = NNG_OPT_WS_REQUEST_HEADERS;
  NNG_OPT_WSS_RESPONSE_HEADERS = NNG_OPT_WS_RESPONSE_HEADERS;

function nng_wss_register: Integer; cdecl; external NNG_LIB;
...
function nng_zt_register: Integer; cdecl; external NNG_LIB;
